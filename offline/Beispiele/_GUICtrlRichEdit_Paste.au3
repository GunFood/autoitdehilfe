...
Func Example()
	Local $hGui, $g_idMnuPasteSplRTF, $g_idMnuPasteSplwObjs
	...
	$g_idMnuPasteSplRTF = GUICtrlCreateMenuItem("Nur RTF ", $g_idMnuPasteSpl)
	$g_idMnuPasteSplwObjs = GUICtrlCreateMenuItem("Mit Objekten", $g_idMnuPasteSpl)
...
;~ 				GUIDelete() 	; ist auch in Ordnung
			...
			Case $g_idMnuPasteSplRTF
				_GUICtrlRichEdit_PasteSpecial($g_hRichEdit, False)
			Case $g_idMnuPasteSplwObjs
