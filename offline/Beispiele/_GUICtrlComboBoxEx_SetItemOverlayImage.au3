...
Func Example()
	...
	; Erstellt eine GUI
	$hGui = GUICreate("ComboBoxEx: Setzt den Index des Icons über der die Maus steht", 500, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Item Overlay Bild: " & _GUICtrlComboBoxEx_GetItemOverlayImage($hCombo, 2))
