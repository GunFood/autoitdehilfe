...
Func Example()
	GUICreate("TreeView: Setzt und ermittelt ToolTips (v" & @AutoItVersion & ")", 500, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Handle des ToolTips: " & _GUICtrlTreeView_GetToolTips($idTreeView))
