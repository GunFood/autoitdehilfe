...
Func Example()
	Local $hGui, $idBtn_Exit, $hReBar, $hToolbar, $idInput, $hToolTip
	...
	$hToolTip = _GUIToolTip_Create($hReBar)

	_MemoWrite("Handle des ToolTips: " & _GUICtrlRebar_GetToolTips($hReBar))

	MsgBox($MB_SYSTEMMODAL, "Information", "Setzt das Handle des ToolTips")
