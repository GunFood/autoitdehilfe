...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Index %d, Vorheriges: %s", $hRandItem, _GUICtrlTreeView_GetPrevSibling($idTreeView, $aidTVi_Item[$hRandItem])))
	_GUICtrlTreeView_SelectItem($idTreeView, _GUICtrlTreeView_GetPrevSibling($idTreeView, $aidTVi_Item[$hRandItem]))
