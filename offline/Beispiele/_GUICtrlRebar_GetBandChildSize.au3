...
Func Example()
	Local $hGui, $idBtnExit, $hReBar, $hToolbar, $idInput, $aChildSize
	...
	For $x = 0 To _GUICtrlRebar_GetBandCount($hReBar) - 1
		...
		MemoWrite("==== Child-Größe ======")
		MemoWrite("cxMinChild: " & $aChildSize[0])
		MemoWrite("cyMinChild: " & $aChildSize[1])
		MemoWrite("cyChild...: " & $aChildSize[2])
		MemoWrite("cyMaxChild: " & $aChildSize[3])
		MemoWrite("cyIntegral: " & $aChildSize[4])
		MemoWrite("======================")
	Next
