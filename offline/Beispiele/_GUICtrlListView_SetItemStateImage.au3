...
Func Example()
	...
	GUICreate("ListView: Setzt das darzustellende Statusbild", 400, 300)
	...
	_GUICtrlListView_AddColumn($idListView, "Spalte 1", 140)
	...
	; Setzt das darzustellende Statusbild von Item 2
	_GUICtrlListView_SetItemStateImage($idListView, 1, 1)
	MsgBox($MB_SYSTEMMODAL, "Information", "Statusbild von Item 2: " & _GUICtrlListView_GetItemStateImage($idListView, 1))
