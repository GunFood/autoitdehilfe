...
Func Example()
	...
	$g_idMnu_PasteSpl = GUICtrlCreateMenu("Einfügen Spezial", $g_idMnu)
	$idMni_PasteSplRTF = GUICtrlCreateMenuItem("Nur RTF ", $g_idMnu_PasteSpl)
	$idMni_PasteSplwObjs = GUICtrlCreateMenuItem("Mit Objekten", $g_idMnu_PasteSpl)
