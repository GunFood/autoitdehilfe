...
Func _Example()
	...
	Local $sFile = FileOpenDialog("Bild auswählen", "", "Bilder (*.bmp;*.png;*.jpg;*.gif;*.tif)")
...
Func _DrawHistogram($tHistogram)
	...
	_GDIPlus_GraphicsDrawString($g_hGfx_Buffer_H, "Rot", 30, -15)
	...
	_GDIPlus_GraphicsFillRect($g_hGfx_Buffer_H, 1, 102, 255, 16, $hBrush)
	_GDIPlus_GraphicsDrawRect($g_hGfx_Buffer_H, 1, 102, 255, 16, $hPen)
	_GDIPlus_GraphicsDrawString($g_hGfx_Buffer_H, "Grün", 30, -15)
	...
	_GDIPlus_GraphicsFillRect($g_hGfx_Buffer_H, 1, 102, 255, 16, $hBrush)
	_GDIPlus_GraphicsDrawRect($g_hGfx_Buffer_H, 1, 102, 255, 16, $hPen)
	_GDIPlus_GraphicsDrawString($g_hGfx_Buffer_H, "Blau", 30, -15)
	...
	_GDIPlus_GraphicsFillRect($g_hGfx_Buffer_H, 1, 102, 255, 16, $hBrush)
	_GDIPlus_GraphicsDrawRect($g_hGfx_Buffer_H, 1, 102, 255, 16, $hPen)
	_GDIPlus_GraphicsDrawString($g_hGfx_Buffer_H, "Grau", 30, -15)
