...
Func Example()
	...
	_MemoWrite("Kleinstes auswählbares Datum: " & _GUICtrlMonthCal_GetRangeMinStr($idMonthCal))
	_MemoWrite("Größtes auswählbares Datum: " & _GUICtrlMonthCal_GetRangeMaxStr($idMonthCal))
