...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Spalte 2 verstecken")
	MsgBox($MB_SYSTEMMODAL, "Information", "Spalte 2 wurde versteckt: " & _GUICtrlListView_HideColumn($idListView, 1))
