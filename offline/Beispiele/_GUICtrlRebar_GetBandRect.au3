...
Func Example()
	Local $hGui, $idBtn_Exit, $hReBar, $hToolbar, $idInput, $aBorders
	...
	For $x = 0 To _GUICtrlRebar_GetBandCount($hReBar) - 1
		$aBorders = _GUICtrlRebar_GetBandBorders($hReBar, $x)
		_MemoWrite("Gruppenindex " & $x)
		_MemoWrite("==== Ränder der Gruppe ====")
		_MemoWrite("Links..: " & $aBorders[0])
		_MemoWrite("Oben...: " & $aBorders[1])
		_MemoWrite("Rechts.: " & $aBorders[2])
		_MemoWrite("Unten..: " & $aBorders[3])
		_MemoWrite("======================")
		$aBorders = _GUICtrlRebar_GetBandRect($hReBar, $x)
