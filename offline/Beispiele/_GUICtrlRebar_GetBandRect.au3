...
Func Example()
	Local $hGui, $idBtnExit, $hReBar, $hToolbar, $idInput, $aBorders
	...
	For $x = 0 To _GUICtrlRebar_GetBandCount($hReBar) - 1
		...
		MemoWrite("Links..: " & $aBorders[0])
		MemoWrite("Oben...: " & $aBorders[1])
		MemoWrite("Rechts.: " & $aBorders[2])
		MemoWrite("Unten..: " & $aBorders[3])
		MemoWrite("======================")
