...
Func Example()
	Local $ahItem[6], $g_hImage, $iRand, $idTreeView
	Local $iStyle = BitOR($TVS_EDITLABELS, $TVS_HASBUTTONS, $TVS_HASLINES, $TVS_LINESATROOT, $TVS_DISABLEDRAGDROP, $TVS_SHOWSELALWAYS, $TVS_CHECKBOXES)

	GUICreate("TreeView: Setzt die Farbe die für die Einfügemarke verwendet werden soll", 600, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Farbe die für die Einfügemarke: " & _GUICtrlTreeView_GetInsertMarkColor($idTreeView))
