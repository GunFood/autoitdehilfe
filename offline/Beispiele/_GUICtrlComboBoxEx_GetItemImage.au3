...
Func Example()
	; Erstellt eine GUI
	Local $hGUI = GUICreate("ComboBoxEx: Setzt und ermittelt das Itembild (v" & @AutoItVersion & ")", 500, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Itembild: " & _GUICtrlComboBoxEx_GetItemImage($hCombo, 0))
