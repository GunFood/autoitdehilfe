...
Func Example()
	...
	MemoWrite("========== Gruppenfarbe ==========")
	MemoWrite("Vorherige Hintergrundfarbe.: " & _GUICtrlRebar_SetBKColor($hReBar, Int(0x00008B)))
	MemoWrite("Hintergrundfarbe...........: " & _GUICtrlRebar_GetBKColor($hReBar))
