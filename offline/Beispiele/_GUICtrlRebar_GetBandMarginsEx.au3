...
Func Example()
	Local $hGui, $idBtn_Exit, $hReBar, $hToolbar, $idInput, $tMargins
	...
	_MemoWrite("===================================")
	_MemoWrite("Mindestvoraussetzung -> Win XP")
	_MemoWrite("Die Ränder sind abhängig von dem Design-Thema")
	_MemoWrite("===================================")
	_MemoWrite("Linke Breite.: " & DllStructGetData($tMargins, "cxLeftWidth"))
	_MemoWrite("Rechte Breite: " & DllStructGetData($tMargins, "cxRightWidth"))
	_MemoWrite("Obere Höhe...: " & DllStructGetData($tMargins, "cyTopHeight"))
	_MemoWrite("Untere Höhe..: " & DllStructGetData($tMargins, "cyBottomHeight"))
	_MemoWrite("======================")
