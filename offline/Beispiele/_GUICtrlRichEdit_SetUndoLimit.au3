			...
			Case $iMsg = $idBtnNext
				...
				Switch $iStep
					Case 1
						...
						GUICtrlSetData($idLblMsg, 'Anzahl der Aktionen, die in der Rückgängig-Schlange gespeichert werden können, von 100 auf 200 erhöht')
					Case 2
						_GUICtrlRichEdit_SetUndoLimit($hRichEdit, 0)
						GUICtrlSetData($idLblMsg, "Rückgängig ist deaktiviert")
