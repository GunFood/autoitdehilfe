...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Item %d angehakt? %s", $hRandomItem, _GUICtrlTreeView_GetChecked($idTreeView, $ahItem[$hRandomItem])))
	_GUICtrlTreeView_SetChecked($idTreeView, $ahItem[$hRandomItem])
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Item %d angehakt? %s", $hRandomItem, _GUICtrlTreeView_GetChecked($idTreeView, $ahItem[$hRandomItem])))
