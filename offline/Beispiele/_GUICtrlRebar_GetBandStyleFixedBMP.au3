...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Setzt den Stil: Bitmap fixieren")
	_GUICtrlRebar_SetBandStyleFixedBMP($hReBar, 1)

	For $x = 0 To _GUICtrlRebar_GetBandCount($hReBar) - 1
		_MemoWrite("Gruppenindex " & $x & @TAB & "$RBBS_FIXEDBMP......: " & _GUICtrlRebar_GetBandStyleFixedBMP($hReBar, $x))
		_MemoWrite("============================================")
	Next
