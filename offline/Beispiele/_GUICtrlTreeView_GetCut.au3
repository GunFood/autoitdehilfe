...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Ist Item %d Teil einer Ausschneide-/ Einfüge-Operation %s", $hRandomItem, _GUICtrlTreeView_GetCut($idTreeView, $aidTVi_Item[$hRandomItem])))
	_GUICtrlTreeView_SetCut($idTreeView, $aidTVi_Item[$hRandomItem])
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Ist Item %d Teil einer Ausschneide-/ Einfüge-Operation %s", $hRandomItem, _GUICtrlTreeView_GetCut($idTreeView, $aidTVi_Item[$hRandomItem])))
