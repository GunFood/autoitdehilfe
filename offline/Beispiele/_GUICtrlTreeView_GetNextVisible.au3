...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", StringFormat("Index %d, nächstes sichtbares: %s", $hRandItem, _GUICtrlTreeView_GetNextVisible($idTreeView, $aidTVi_Item[$hRandItem])))
	_GUICtrlTreeView_SelectItem($idTreeView, _GUICtrlTreeView_GetNextVisible($idTreeView, $aidTVi_Item[$hRandItem]))
