...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Setzt den Stil: Versteckt")
	_GUICtrlRebar_SetBandStyleHidden($hReBar, 1)

	For $x = 0 To _GUICtrlRebar_GetBandCount($hReBar) - 1
		_MemoWrite("Gruppenindex " & $x & @TAB & "$RBBS_HIDDEN........: " & _GUICtrlRebar_GetBandStyleHidden($hReBar, $x))
		_MemoWrite("============================================")
	Next

	MsgBox($MB_SYSTEMMODAL, "Information", "Setzt den Stil: Versteckt")
	_GUICtrlRebar_SetBandStyleHidden($hReBar, 1, False)
