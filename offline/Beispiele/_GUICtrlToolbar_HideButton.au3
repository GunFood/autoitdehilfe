...
Func Example()
	...
	; Versteckt den Speichern Button
	MsgBox($MB_SYSTEMMODAL, "Information", "Versteckt den Speichern Button")
	_GUICtrlToolbar_HideButton($hToolbar, $e_idSave, True)
	MsgBox($MB_SYSTEMMODAL, "Information", "Stellt den Speichern Button wieder her")
	_GUICtrlToolbar_HideButton($hToolbar, $e_idSave, False)
