...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Setzt den Stil: Dropdown-Button")
	_GUICtrlRebar_SetBandStyleUseChevron($hReBar, 1)

	For $x = 0 To _GUICtrlRebar_GetBandCount($hReBar) - 1
		_MemoWrite("Gruppenindex " & $x & @TAB & "$RBBS_USECHEVRON....: " & _GUICtrlRebar_GetBandStyleUseChevron($hReBar, $x))
		_MemoWrite("============================================")
	Next

	MsgBox($MB_SYSTEMMODAL, "Information", "Setzt den Stil: Dropdown-Button")
	_GUICtrlRebar_SetBandStyleUseChevron($hReBar, 1, False)
