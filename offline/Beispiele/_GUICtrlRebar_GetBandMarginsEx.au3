...
Func Example()
	Local $hGui, $idBtnExit, $hReBar, $hToolbar, $idInput, $tMargins
	...
	MemoWrite("===================================")
	MemoWrite("Mindestvoraussetzung -> Win XP")
	MemoWrite("Die Ränder sind abhängig von dem Design-Thema")
	MemoWrite("===================================")
	MemoWrite("Linke Breite.: " & DllStructGetData($tMargins, "cxLeftWidth"))
	MemoWrite("Rechte Breite: " & DllStructGetData($tMargins, "cxRightWidth"))
	MemoWrite("Obere Höhe...: " & DllStructGetData($tMargins, "cyTopHeight"))
	MemoWrite("Untere Höhe..: " & DllStructGetData($tMargins, "cyBottomHeight"))
	MemoWrite("======================")
