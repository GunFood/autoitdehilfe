...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Zum verstecken einer Gruppe wird _GUICtrlRebar_ShowBand verwendet")
	_GUICtrlRebar_ShowBand($hReBar, 0, False)

	MsgBox($MB_SYSTEMMODAL, "Information", "Zum zeigen einer Gruppe wird _GUICtrlRebar_ShowBand verwendet")
