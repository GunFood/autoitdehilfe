...
Func Example()
	...
	GUICreate("TreeView: Item einfügen", 400, 300)
	...
	$iRand = Random(0, 29, 1)
	$hInsert = _GUICtrlTreeView_InsertItem($idTreeView, "Eingefügtes Item", _GUICtrlTreeView_GetParentHandle($idTreeView, $aidChildItem[$iRand]), $aidChildItem[$iRand])
