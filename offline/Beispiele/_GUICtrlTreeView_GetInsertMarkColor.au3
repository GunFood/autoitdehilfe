...
Func Example()
	...
	GUICreate("TreeView: Ermittelt die Farbe die für die Einfügemarke verwendet wird", 600, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Farbe der Einfügemarke: " & _GUICtrlTreeView_GetInsertMarkColor($idTreeView))
