...
Func Example()
	...
	_MemoCreate(2, 36, 416, 262, $WS_VSCROLL)
	GUISetState(@SW_SHOW)
	...
	_MemoWrite("Vorheriges Handle der deaktivierten Imagelist .: 0x" & Hex($hPrevImageList))
	...
	_MemoWrite("IsPtr = " & IsPtr(_GUICtrlToolbar_GetDisabledImageList($hToolbar)) & " IsHWnd = " & IsHWnd(_GUICtrlToolbar_GetDisabledImageList($hToolbar)))
