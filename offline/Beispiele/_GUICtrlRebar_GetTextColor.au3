...
Func Example()
	...
	_MemoWrite("========== Gruppenfarbe ==========")
	_MemoWrite("Vorherige Hintergrundfarbe.: " & _GUICtrlRebar_SetBKColor($hReBar, Int(0x00008B)))
	_MemoWrite("Hintergrundfarbe...........: " & _GUICtrlRebar_GetBKColor($hReBar))
