...
Func Example()
	...
	_MemoWrite("----------------")
	_MemoWrite("Links .: " & DllStructGetData($tRECT, "Left"))
	_MemoWrite("Oben ..: " & DllStructGetData($tRECT, "Top"))
	_MemoWrite("Rechts : " & DllStructGetData($tRECT, "Right"))
	_MemoWrite("Unten .: " & DllStructGetData($tRECT, "Bottom"))
