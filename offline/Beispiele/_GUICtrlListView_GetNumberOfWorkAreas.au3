...
Func Example()
	...
	GUICreate("ListView: Ermittelt die Anzahl von Arbeitsflächen", 400, 300)
	...
	MsgBox(8192 + 64, "Information", "Arbeitsflächen: " & _GUICtrlListView_GetNumberOfWorkAreas($idListView))
