...
Func Example()
	Local $hGui, $idBtnExit, $hReBar, $hToolbar, $idInput, $aMargins
	...
	MemoWrite("Die Ränder sind abhängig vom Design-Thema")
	MemoWrite("===================================")
	MemoWrite("Linke Breite...: " & $aMargins[0])
	MemoWrite("Rechte Breite..: " & $aMargins[1])
	MemoWrite("Obere Höhe.....: " & $aMargins[2])
	MemoWrite("Untere Höhe....: " & $aMargins[3])
	MemoWrite("======================")
