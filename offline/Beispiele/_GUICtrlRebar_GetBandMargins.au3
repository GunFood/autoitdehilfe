...
Func Example()
	Local $hGui, $idBtn_Exit, $hReBar, $hToolbar, $idInput, $aMargins
	...
	$aMargins = _GUICtrlRebar_GetBandMargins($hReBar)
	_MemoWrite("==== Ränder der Gruppe ====")
	_MemoWrite("===================================")
	_MemoWrite("Mindestvoraussetzung -> Win XP")
	_MemoWrite("Die Ränder sind abhängig vom Design-Thema")
	_MemoWrite("===================================")
	_MemoWrite("Linke Breite...: " & $aMargins[0])
	_MemoWrite("Rechte Breite..: " & $aMargins[1])
	_MemoWrite("Obere Höhe.....: " & $aMargins[2])
	_MemoWrite("Untere Höhe....: " & $aMargins[3])
	_MemoWrite("======================")
