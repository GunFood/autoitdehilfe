...
Func Example()
	GUICreate("ListView: Setzt und ermittelt die erweiterten ListView Stile (v" & @AutoItVersion & ")", 600, 300)
	...
	_GUICtrlListView_InsertItem($idListview, "Zeile 0: Spalte 0", -1, 0)
	...
	_GUICtrlListView_InsertItem($idListview, "Zeile 1: Spalte 0", -1, 1)
	_GUICtrlListView_AddSubItem($idListview, 1, "Zeile 1: Spalte 1", 1, 2)
	_GUICtrlListView_InsertItem($idListview, "Zeile 2: Spalte 0", -1, 2)
