...
Func _Example()
    If Not _GDIPlus_Startup() Or @extended < 6 Then
		MsgBox($MB_SYSTEMMODAL, "ERROR", "GDIPlus.dll v1.1 ist nicht verfügbar")
		Return
	EndIf
...
; Der folgende Code wurde mit 'File to Base64 String' Code Generator v1.11 Build 2012-10-13 erstellt
