...
Func Example()
	...
	Else
		_GUICtrlListView_SetGroupInfo($idListView, 1, "Neue Gruppe 1", 0, $LVGS_FOCUSED)
		MsgBox($MB_SYSTEMMODAL, "Information", "Die Gruppe mit dem folgenden Index hat den Fokus: " & _GUICtrlListView_GetFocusedGroup($idListView))
	EndIf
