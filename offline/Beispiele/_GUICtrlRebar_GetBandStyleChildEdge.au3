...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Setzt den Stil: Kante anzeigen")

	For $x = 0 To _GUICtrlRebar_GetBandCount($hReBar) - 1
		_GUICtrlRebar_SetBandStyleChildEdge($hReBar, $x, False)
		_MemoWrite("Gruppenindex " & $x & @TAB & "$RBBS_CHILDEDGE.....: " & _GUICtrlRebar_GetBandStyleChildEdge($hReBar, $x))
		_MemoWrite("============================================")
	Next
