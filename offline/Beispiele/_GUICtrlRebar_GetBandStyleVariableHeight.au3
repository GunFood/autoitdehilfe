...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Setzt den Stil: Variable Höhe")
	_GUICtrlRebar_SetBandStyleVariableHeight($hReBar, 1)

	For $x = 0 To _GUICtrlRebar_GetBandCount($hReBar) - 1
		_MemoWrite("Gruppenindex " & $x & @TAB & "$RBBS_VARIABLEHEIGHT: " & _GUICtrlRebar_GetBandStyleVariableHeight($hReBar, $x))
		_MemoWrite("============================================")
	Next

	MsgBox($MB_SYSTEMMODAL, "Information", "Setzt den Stil: Variable Höhe")
	_GUICtrlRebar_SetBandStyleVariableHeight($hReBar, 1, False)
