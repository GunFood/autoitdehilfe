...
Func Example()
	...
	GUICreate("ListView: Ermittelt, ob das Item dargestellt wird, als wäre es in einer Ausschneide Operation", 400, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Item 2 ausschneiden: " & _GUICtrlListView_GetItemCut($idListView, 1))
