...
Func Example()
	GUICreate("TreeView: Gibt das Item an den festgelegten Koordinaten zurück (v" & @AutoItVersion & ")", 600, 300)
...
Func _GetHitString($iResult)
	If $iResult = 0 Then
		Return @CRLF & "Es befindet sich kein Item im angeklickten Bereich!"
	Else
