...
Func Example()
	...
	MemoWrite("Kleinstes auswählbares Datum: " & _GUICtrlMonthCal_GetRangeMinStr($idMonthCal))
	MemoWrite("Größtes auswählbares Datum: " & _GUICtrlMonthCal_GetRangeMaxStr($idMonthCal))
