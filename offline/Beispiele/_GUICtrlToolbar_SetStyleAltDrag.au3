...
Func Example()
	...
	_MemoWrite("Zeigt an, ob das Control es erlaubt, dass Buttons mitgeschleppt werden können .: " & $bStyle)
	_GUICtrlToolbar_SetStyleAltDrag($hToolbar, Not $bStyle)
	_MemoWrite("Zeigt an, ob das Control es erlaubt, dass Buttons mitgeschleppt werden können .: " & _GUICtrlToolbar_GetStyleAltDrag($hToolbar))
