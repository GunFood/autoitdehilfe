...
Func Example()
	...
	; Erstellt eine GUI
	GUICreate("ListBox: Textlänge ermitteln", 400, 296)
	...
	; Zeigt die Itemtextlänge
	MsgBox($MB_SYSTEMMODAL, "Information", "Item 5 Textlänge: " & _GUICtrlListBox_GetTextLen($idListBox, 4))
