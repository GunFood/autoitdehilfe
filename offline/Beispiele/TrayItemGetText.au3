...
Func Example()
	Local $idGetText = TrayCreateItem("Ermittelt den 'Über' Text")
	...
	While 1
		Switch TrayGetMsg()
			...
			Case $idGetText
				; Zeigt ein Nachrichtenfenster über den Text des 'Über' Items.
				MsgBox($MB_SYSTEMMODAL, "", "Der Text des 'Über' Items lautet: " & TrayItemGetText($idAbout))
