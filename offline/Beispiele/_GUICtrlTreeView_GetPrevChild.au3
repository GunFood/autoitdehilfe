...
Func Example()
	Local $aidItem[10], $hLastChild, $idTreeView
	...
	For $x = 0 To 3
		...
		Next
	Next
	$aidItem[4] = GUICtrlCreateTreeViewItem(StringFormat("[%02d] Neues Item", 5), $idTreeView)
	For $x = 5 To 9
		$aidItem[$x] = GUICtrlCreateTreeViewItem(StringFormat("[%02d] Neues Item", $x + 1), $idTreeView)
	...
	$hLastChild = _GUICtrlTreeView_GetLastChild($idTreeView, $aidItem[2])
