...
;~     _GUICtrlToolbar_SetUnicodeFormat($hToolbar, False)
	...
	_MemoWrite("Bilderindex ....: " & DllStructGetData($tButton, "Image"))
	_MemoWrite("Statusflag .....: " & DllStructGetData($tButton, "State"))
	_MemoWrite("Buttonbreite ...: " & DllStructGetData($tButton, "CX"))
	_MemoWrite("Parameter ......: " & DllStructGetData($tButton, "Param"))
