...
Func Example()
	...
	; Erstellt eine GUI
	$hGui = GUICreate("ComboBoxEx: Setzt die Anzahl von Bilderbreiten die das Item eingerückt werden soll", 700, 300)
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Einrückung des Items: " & _GUICtrlComboBoxEx_GetItemIndent($hCombo, 2))
