...
Func Example()
	...
	; Erstellt eine GUI
	GUICreate("MonthCal: setzt das minimal und maximal erlaubte Datum", 550, 300)
	...
	MemoWrite("minimal auswählbares Datum: " & StringFormat("%02d/%02d/%04d", DllStructGetData($tRange, "MinMonth"), _
			DllStructGetData($tRange, "MinDay"), _
			DllStructGetData($tRange, "MinYear")))
	MemoWrite("maximal auswählbares Datum: " & StringFormat("%02d/%02d/%04d", DllStructGetData($tRange, "MaxMonth"), _
