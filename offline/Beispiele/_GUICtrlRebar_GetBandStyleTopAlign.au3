...
Func Example()
	...
	MsgBox($MB_SYSTEMMODAL, "Information", "Das Child-Fenster der Gruppe wird oben-bündig ausgerichtet")
	_GUICtrlRebar_SetBandStyleTopAlign($hReBar, 1)

	For $x = 0 To _GUICtrlRebar_GetBandCount($hReBar) - 1
		_MemoWrite("Gruppenindex " & $x & @TAB & "$RBBS_TOPALIGN......: " & _GUICtrlRebar_GetBandStyleTopAlign($hReBar, $x))
		_MemoWrite("============================================")
	Next
