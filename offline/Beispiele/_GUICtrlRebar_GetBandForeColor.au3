...
Func Example()
	Local $hGui = GUICreate("Rebar: Setzt die Vordergrundfarbe der Gruppe (v" & @AutoItVersion & ")", 500, 396, -1, -1, BitOR($WS_MINIMIZEBOX, $WS_CAPTION, $WS_POPUP, $WS_SYSMENU, $WS_MAXIMIZEBOX))
