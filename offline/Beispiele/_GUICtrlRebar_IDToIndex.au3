...
Func Example()
	...
	_MemoWrite("Setzt die ID von dem Gruppenindex 0: " & _GUICtrlRebar_GetBandID($hReBar, 0))

	_MemoWrite("Verschiebt die Gruppe von Index 0 -> 2: " & _GUICtrlRebar_MoveBand($hReBar, 0, 2))

	_MemoWrite("ID 2246, Index: " & _GUICtrlRebar_IDToIndex($hReBar, 2246))
